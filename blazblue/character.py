...
from database.psql.models import Character as CharacterModel, Move, Gatling
from discord import Embed, File
from sqlalchemy import select, and_
from tools import string_match, StringNotFoundError
...
class Character:
    ...
    def __init__(self, database: Database, name: str, game_id: int, is_changed_allowed: bool = False):
        ...
        character_name: str = name.split(' ', 1)[0]
        self._name: str = self.parse_character_name(character_name.lower() if ' ' in name else name.lower())
